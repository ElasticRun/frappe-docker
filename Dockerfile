...
# Provides a way for child images to override entrypoints. As a side-effect, entrypoints become mandatory for the child images.
...
# Uncomment this line if you want to force execution of layers in docker - else, docker will pick up cached layers.
